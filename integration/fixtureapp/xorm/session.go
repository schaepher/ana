...
func (s *Session) And(query interface{}, args ...interface{}) *Session { return s }

func (s *Session) Or(query interface{}, args ...interface{}) *Session { return s }

func (s *Session) In(query interface{}, args ...interface{}) *Session { return s }

func (s *Session) NotIn(query interface{}, args ...interface{}) *Session { return s }
...
func (s *Session) Exec(sql interface{}, args ...interface{}) (int64, error) { return 0, nil }
...
func (e *Engine) Exec(sql interface{}, args ...interface{}) (int64, error) { return 0, nil }
